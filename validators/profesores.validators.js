...
const validateProfesores = (user) => {
  const properties = ['primer_nombre', 'primer_apellido', 'genero','nombre_convocatoria' ,'actividad', 'duracion', 'financiacion', 'tipo_recursos' , 'tipo_doc_id', 
  'documento_id','periodo_inscrip', 'ano_inscrip', 'fecha_inscripcion', 'celular', 'correo']
