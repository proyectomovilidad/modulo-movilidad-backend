...
const validateConvenio = (user) => {
  const properties = ['nombre_convenio', 'version_convenio', 'programa_acad', 'promedio' , 'cupo',
   'estado_convenio', 'fecha_inicio', 'fecha_final', 'fecha_suscripcion', 'tipo_convenio', 'tipo_movilidad']
...
const transformObjectId = (padlock) => {
 ...
 validator.validateAndTransformId(padlock, 'estado_convenio', 'El id del estado del convenio no es valido')
